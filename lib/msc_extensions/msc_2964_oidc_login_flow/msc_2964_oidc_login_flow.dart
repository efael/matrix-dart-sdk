...
extension Msc2964OidcLoginFlow on Client {
  ...
  Future<OidcLoginSession> initOidcLoginSession({
    ...
    final authentiationUri = authMetadata.authorizationEndpoint.replace(
      queryParameters: {
    ...
    return OidcLoginSession(
      ...
      authentiationUri: authentiationUri,
...
class OidcLoginSession {
  ...
  final Uri authentiationUri, redirectUri;
  final String codeVerifier, state;

  OidcLoginSession({
    required this.oidcClientData,
    required this.authentiationUri,
